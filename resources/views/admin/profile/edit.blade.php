...
| ADMIN PROFILE
|--------------------------------------------------------------------------
| Profile page UI (match USER UI)
|
| Update:
| - Same avatar + name styling as user profile
| - Add confirmation modal for LOGOUT
| - Add confirmation modal for DELETE ACCOUNT
| - Activity Logs: list + pagination ONLY (no filters)
|--------------------------------------------------------------------------
--}}
@extends('layouts.app')
...
<style>
    ...
    .btn-logout { background: var(--postit-green); }
    .btn-delete { background: var(--postit-purple); }
    ...
    .modal-cancel { background: var(--postit-orange); }
    .modal-confirm-logout { background: var(--postit-green); }
    .modal-confirm-delete { background: var(--postit-purple); }
</style>
@endpush
...
<div class="profile-wrap">
    ...
    <div class="profile-main">
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-meta">
                        Member since {{ optional($user->created_at)->format('F j, Y') }}
                    </div>
                </div>
            </div>
        ...
        <div class="activity-shell">
            <div class="activity-head">ACTIVITY LOGS</div>
