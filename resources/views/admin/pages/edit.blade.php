...
@section('content')
@php
$isSystem = in_array($page->slug, ['about-us', 'contact']);
@endphp
    ...
    <div class="inner">
        <div class="top-row">
            <div class="title-block">
                <h1>Edit Page</h1>
                <p>Use templates to preserve your landing page styling + preview before saving.</p>
            </div>
        ...
        <div class="meta">
            <div><b>Slug:</b> {{ $page->slug }}</div>
            <div><b>Status:</b> {{ ucfirst($page->status) }}</div>
            <div><b>Published:</b> {{ $page->published_at ? $page->published_at->format('F j, Y') : '—' }}</div>
            <div><b>Updated:</b> {{ $page->updated_at ? $page->updated_at->format('F j, Y') : '—' }}</div>
        </div>
                ...
                <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
                    ...
                    <div class="grid2">
                        ...
                        <div class="field">
                            ...
                            <div class="hint">
                                Keep slug as <b>about-us</b> and <b>contact</b> for landing sections.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="editor-grid">
                        <div class="field">
                            ...
                            <div class="hint">
                                Tip: Keep the same classes (<code>about-grid</code>, <code>contact-title</code>, etc.) to preserve styling.
                            </div>
                        </div>
                        ...
                        <div class="field" id="previewWrap">
                            ...
                            <div class="hint">
                                This preview renders HTML. If you paste bad HTML, the preview may look off.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="actions">
                        ...
                        <a class="view-link" href="{{ route('page.show', $page->slug) }}" target="_blank">View Public ↗</a>
                    </div>
                </form>
            </div>
        </div>
